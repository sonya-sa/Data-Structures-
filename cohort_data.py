...
def unique_houses(filename):
    ...
    # houses = set([])
    # # Code goes here
    # all_students = open(cohort_data.txt)

    # for student_house in all_students:
    #     for house_name in student_house:
    #         set([unique_house])
    ...
    for line in house_file:
        ...
        first_name = info[0]
        last_name = info[1]
        student_house = info[2]
        advisor = info[3]
        cohort = info[4]


        house.add(student_house)
...
def sort_by_cohort(filename):
    ...
    for line in house_file:
        ...
        first_last_name = info[0] + ' ' + info[1]
        student_house = info[2]
        advisor = info[3]
        cohort = info[4]

        if cohort == "G":
            ghosts.append(first_last_name)
        elif cohort == "Fall 2015":
            fall_15.append(first_last_name)
        elif cohort == "Summer 2016":
            summer_16.append(first_last_name)
        elif cohort == "Spring 2016":
            spring_16.append(first_last_name)
        elif cohort == "Winter 2016":
            winter_16.append(first_last_name)
...
def hogwarts_by_house(filename):
    ...
    for line in house_file:
        ...
        elif student_house == "Dumbledore's Army":
    ...
    all_hogwarts = [sorted(dumbledores_army),sorted(gryffindor), sorted(hufflepuff),  
